About opentelemetry-instrumentation-marqo-feedstock
===================================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/opentelemetry-instrumentation-marqo-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/opentelemetry-instrumentation-marqo-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add opentelemetry-instrumentation-marqo
# for installing globally
pixi global install opentelemetry-instrumentation-marqo
```
...
It is possible to list all of the versions of `opentelemetry-instrumentation-marqo` available on your platform:
...
```
pixi search opentelemetry-instrumentation-marqo --channel conda-forge
```
